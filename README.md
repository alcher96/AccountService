...
Определены события согласно техническому заданию, а так же Consumer "заглушка", при срабатывании которых можно увидеть соответствующий "всплеск" на графике очереди Message Rate.
